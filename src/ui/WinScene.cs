...
namespace CardGame
{
	...
	public class WinScene : Scene
	{
		...
		public WinScene(Microsoft.Xna.Framework.Content.ContentManager content) : base(content)
		{
		}
		...
		public override void DrawScene(SpriteBatch spriteBatch)
		{
			...
			spriteBatch.Begin();
			spriteBatch.Draw(CardResources.Instance.UiTexture("winnerBackground"), new Vector2(0, 0), Color.White);
